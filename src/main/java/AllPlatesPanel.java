...
public class AllPlatesPanel extends JPanel {
  ...
  private String project_sys_name;
    ...
    public AllPlatesPanel(Session _s, CustomTable _table, String _project_sys_name) {
    ...
    FilterPanel fp = new FilterPanel(session, table, Integer.parseInt(project_sys_name.substring(4)) ,DialogMainFrame.ALLPLATES );
  ...
  public void updatePanel(String _project_sys_name) {
    String project_sys_name = _project_sys_name;
      ...
      JTable table = session.getDatabaseRetriever().getDMFTableData(project_id, DialogMainFrame.ALLPLATES, null);
