...
////////////////////////////////////////////////////////////
   ...
   javax.swing.border.TitledBorder sourceLayoutBorder = BorderFactory.createTitledBorder("Source:");
    ...
    sourceTable = session.getDatabaseRetriever().getSourceForLayout(96);
    ...
    destTable = session.getDatabaseRetriever().getDestForLayout(1);
   ...
   ////////////////////////////////////////////////////////////
    ...
    if (e.getSource() == helpButton) {
	      session.openHelpPage( "layouts");
     }

     if (e.getSource() == repsButton) {
	      session.openHelpPage( "replication");
