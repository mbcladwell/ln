    ...
    */
    ...
    refreshButton.addActionListener(
        new ActionListener() {
	      ...
	      switch(entity_type){
	      case DialogMainFrame.PROJECT: session.getDialogMainFrame().showProjectTable();
		  break;
	      ...
	      //  JTable table2 =  session.getDatabaseRetriever().getDMFTableData(id, entity_type );
    ...
    globalButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {	      
              session.getDialogMainFrame().showGlobalQueryTable(textField.getText());
	  }
        });
